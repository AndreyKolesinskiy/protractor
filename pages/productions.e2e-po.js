...
function ProductionsPage() {    
    ...
    that.nod = element(by.tagName('body')).element(by.cssContainingText('.aciTreeText', '40, Herbst/Winter 2015/2016'));
    that.sub1 = element(by.tagName('body')).element(by.cssContainingText('.aciTreeText', 'Prospekt'));
    that.sub2 = element(by.tagName('body')).element(by.cssContainingText('.aciTreeText', '6556 Schwarzpreis ET: 02.03.2017'));        
}